...
const labelsSchema = new mongoose.Schema({
    ...
    resourceType: {
        ...
        default: 'VPC',
        validate(value){
            if (!value.match(/(ESX|VM|DC|TMP|HPV|CLS|NETW|PHY|NOSQL|SQL|CON|FUNC|BLOB|VPC|API|SMS|MAIL|GRP|USR|NLB|DNS|APP|WEB|WEBVM|DBVM|EC2|DYN|S3|ECS|BEAN|STATE|EBS|RDS)/)){
